...
import userinterface.ProviderRole.ProviderAdminWorkAreaJPanel;
...
public class ProviderRole extends Role{
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system,Clinic clinic) {
        return new ProviderAdminWorkAreaJPanel(userProcessContainer, account, (ProviderOrganization)organization, enterprise, system);
    }
